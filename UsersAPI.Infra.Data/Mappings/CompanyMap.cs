...
namespace UsersAPI.Infra.Data.Mappings
{
    public class CompanyMap : IEntityTypeConfiguration<Company>
    {
        public void Configure(EntityTypeBuilder<Company> builder)
        {
            ...
            builder.Property(c => c.ImgLogo).HasMaxLength(70);
            builder.Property(c => c.InscMunicipal).HasMaxLength(14);
            builder.Property(c => c.InscEstadual).HasMaxLength(9);
            builder.Property(c => c.Cnae).HasMaxLength(7);
            builder.Property(c => c.Crt).HasMaxLength(14);
            builder.Property(c => c.Email).HasMaxLength(80).IsRequired();
            builder.Property(c => c.Url).HasMaxLength(50);
            builder.Property(c => c.FoneNumber1).HasMaxLength(13).IsRequired();
            builder.Property(c => c.FoneNumber2).HasMaxLength(13);
